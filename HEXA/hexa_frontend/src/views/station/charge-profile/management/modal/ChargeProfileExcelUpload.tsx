/**
 * 충전프로파일 엑셀 업로드 ExcelUpload Component
 * URL: /station/charge-profile/management > 엑셀업로드
 */
...
const ChargeProfileExcelUpload = (props: any) => {
  ...
  const onFileUpload = async () => {
    ...
    try {
			const response = await StationApiService().excelUploadChargeProfile(formData);
  ...
  return (
    <Dialog title={t("station.charge_profile_excel_upload")} onClose={onClose}> {/* 충전 프로파일 엑셀 업로드 */}
        ...
        <div className="file-upload-info">
          ...
          <div className="info-btns">
            <Button 
              ...
              fillMode="outline" 
              themeColor={"light"}
              onClick={() => fileDownload("HEXA_CProfile_Register_sample.xlsx")}
            >
              {/* 신규 등록용  */}
              {t("station.new_register_excel")}
            ...
            <Button 
              ...
              fillMode="outline" 
              themeColor={"light"}
              onClick={() => fileDownload("HEXA_CProfile_Mapping_sample.xlsx")}
            >
              {/* 조건NO 매핑용  */}
              {t("station.matrix_no_excel")}
              <i className="icon icon-down"></i>
            </Button>
          </div>
        </div>
...
export default ChargeProfileExcelUpload;
