/**
 * 스테이션 Data 수집 이력 조회 > 전력량 탭 Component
 * URL: /station/history/data > 전력량 탭
 */
/* React */
...
export default function AccumulatedPower(props: any) {
  ...
  const [columns, setColumns] = useState<GridHeader[]>([
      ...
      cellType: 'dateTime'
		...
		{
			field: "chassAccumPwr",
			title:  `${t('station.power_usage')}(Wh)`, //'전력량(Wh)',
			width: 300,
			align: 'center',
      cellType: 'number'
		}
