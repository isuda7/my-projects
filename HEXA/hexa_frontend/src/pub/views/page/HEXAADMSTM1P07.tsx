// HEXAADMSTM1P07 : 	[P]스테이션ID 코드 엑셀 업로드
...
export default function HEXAADMSTM1P07() {
  ...
  return (
    <>
      ...
      <Button size={"medium"} themeColor={"primary"} onClick={toggleDialog}>
        스테이션ID 코드 엑셀 업로드 팝업 열기
      </Button>

      {/* 스테이션ID 코드 엑셀 업로드 팝업 팝업 */}
      {visible && (
        <Dialog title={"스테이션ID 코드 엑셀 업로드"} onClose={toggleDialog}>
            ...
            <div className="file-upload-info">
              ...
              <div className="info-btns">
                <Button size={"small"} fillMode="outline" themeColor={"light"}>
                  양식 다운로드 <i className="icon icon-down"></i>
                </Button>
              </div>
            </div>
          </div>
