// HEXAADMSTM1P02 : 	[P]스테이션 정보 엑셀 업로드
...
export default function HEXAADMSTM1P02() {
  ...
  return (
    <>
      ...
      <Button size={"medium"} themeColor={"primary"} onClick={toggleDialog}>
        스테이션 정보 엑셀 업로드 팝업 열기
      </Button>

      {/* 스테이션 정보 엑셀 업로드 팝업 */}
      {visible && (
        <Dialog title={"스테이션 정보 엑셀 업로드"} onClose={toggleDialog}>
            ...
            <div className="file-upload-info">
              ...
              <div className="info-btns">
                <Button size={"small"} fillMode="outline" themeColor={"light"}>
                  신규 스테이션용 <i className="icon icon-down"></i>
                </Button>
                <Button size={"small"} fillMode="outline" themeColor={"light"}>
                  기 스테이션용 <i className="icon icon-down"></i>
                </Button>
              </div>
            </div>
          </div>
