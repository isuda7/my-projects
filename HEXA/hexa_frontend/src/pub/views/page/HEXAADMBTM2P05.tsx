...
const sampleProducts = [
  {
    ...
    Name: "GS25잠실점",
    In: "01",
    BatteryID: "20240725100410",
    Out: "02",
    Failed: "Return step. Time Out",
...
export default function HEXAADMBTM2P05() {
  ...
  return (
    <>
      ...
      {/* 교환 및 위치 이력 팝업 */}
      {visible && (
        <Dialog title={"교환 및 위치  이력"} onClose={toggleDialog}>
