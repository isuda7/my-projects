...
const sampleProducts = [
  {
    ...
    CommonCodeID: "N",
    CommonCodeName: "일반 충전",
    CommonCodeNameEN: "Normal Charge",
    Desc: "일반 충전",
    YN: "Yes",
...
export default function HEXAADMSYM2S20() {
  //grid
  ...
  return (
    <>
      ...
      <div className="head-group">
        <h2 className="t-header">공통 코드</h2>
      </div>
