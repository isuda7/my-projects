// HEXAADMHOM2P13 : 	[P]진단 스테이션 목록 - 1세대
...
const sampleProducts = [
  {
    ...
    Name: "GS25 강남점",
    QRID: "C0334",
    Target: "배터리 (2023081808259 / 02)",
    Number: "01",
    Slot: "01",
    Level: "고장",
    CodeName: "DiagPack_CDFET Temp_Fault",
    State: "발생",
  },
  {
    generation: "2",
...
export default function HEXAADMHOM2P08() {
              ...
              <section className="section">
                <div className="sort-group type-dark">
                  ...
                  <div className="group-align-right">
                    <Button fillMode="flat" className="btn-arr-dark">
                      스테이션 고장 이력
                    </Button>
                  </div>
                </div>
