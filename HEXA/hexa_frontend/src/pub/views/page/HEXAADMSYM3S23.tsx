...
export default function HEXAADMSYM3S23() {
  return (
    <>
      ...
      <div className="head-group">
        <h2 className="t-header">공통 코드 상세</h2>
      </div>
              ...
              <table className="tbl-base">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <DropDownList defaultValue="총전조건" className="w200" />
                    </td>
                  </tr>
                  <tr>
                    <th scope="row">
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="in-input w310">
                        <Input defaultValue="Normal Charge" />
                      </div>
                    </td>
                  </tr>
