// HEXAADMSTM1S66 : 충전 프로파일 Factor 상세
...
export default function HEXAADMSTM1S66() {
  return (
    <>
              ...
              <table className="tbl-base">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <DropDownList className="w200" defaultValue="번잡도" />
                    </td>
                  </tr>
                  <tr>
                    <th scope="row">
                    ...
                    <td>
                      <DropDownList className="w200" defaultValue="1" />
                    </td>
                  </tr>
                </tbody>
              </table>
