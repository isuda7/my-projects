...
export default function HEXAADMSTM2S04() {
  ...
  return (
    <>
      ...
      <div className="head-group">
        <h2 className="t-header">스테이션ID 코드 관리</h2>
      </div>
      ...
      <section className="section">
        <div className="sort-group">
          ...
          <div className="group-align-right gap0.38">
            ...
            <Button size={"medium"} themeColor={"primary"} className="w100">
              시코드 추가
            </Button>
            <Button size={"medium"} themeColor={"primary"} className="w100">
              구코드 추가
