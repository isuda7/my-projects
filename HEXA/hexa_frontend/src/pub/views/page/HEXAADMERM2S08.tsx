...
export default function HEXAADMERM2S08() {
  //grid
  ...
  return (
    <>
      ...
      <div className="head-group">
        <h2 className="t-header">통신단절 현황</h2>
      </div>
            ...
            <div>
              ...
              <dd>
                ...
                <span className="datepicker">
                  <span className="cell">
                    <DatePicker defaultValue={value} format={"yyyy-MM-dd"} />
                  </span>
                  ~
                  <span className="cell">
                    <DatePicker
