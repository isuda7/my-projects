...
const sampleProducts = [
  {
    ...
    Division: "일반 충전",
    ServerNo: "C015",
    ServerCondition: "0.45C Step 충전",
    StationNo: "C001",
    StationCondition: "0.3C 4.1V 충전",
...
export default function HEXAADMBTM2S08() {
  ...
  return (
    <>
      ...
      <div className="head-group">
        <h2 className="t-header">배터리 충전 이력</h2>
      </div>
