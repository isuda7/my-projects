...
export default function HEXAADMHOM2S00() {
  ...
  //chart : bar1
  const chartData1 = [
    { g: "2nd", name: "GS25 아름다운미소점", value: "65" },
    { g: "2nd", name: "본도시락 문정법조타운점", value: "58" },
    { g: "1st", name: "하이큐바이크관약점", value: "50" },
    { g: "2nd", name: "GS25 양재강남점", value: "43" },
    { g: "2nd", name: "GS25 신림관악점", value: "20" },
  ];
    ...
    <>
      <div className="home">
        <div className="t-update">
          <span>Update Date & Time 2024-08-05 22:00:10</span>
        ...
        <div className="home-row">
          ...
          <div className="home-box type-ranking">
            <h3>Cumulative Exchange Rank for November</h3>
          ...
          <div className="home-box type-situation">
            ...
            <div className="home-chart-pie">
              <div className="chart-legend">
                <span className="round-g1">1st</span>
                <span className="round-g2">2nd</span>
              </div>
              <div className="chart-total">
                <span className="tit">All</span>
        ...
        <div className="home-row">
          ...
          <div className="home-box type-fail">
            ...
            <div className="home-chart-bar4">
              <div className="chart-legend">
                <span className="round-g1">1st Exchange Failure</span>
                <span className="round-g1-1"> 1st Authentication Failure</span>
                <span className="round-g2">2nd Exchange Failure</span>
                <span className="round-g2-1">2nd Authentication Failure</span>
              </div>
        ...
        <div className="home-row">
          ...
          <div className="home-box type-disconnection">
            <h2>Communication Disconnection Count</h2>
            <Button fillMode="flat" className="btn-arr">
              See More
            </Button>
