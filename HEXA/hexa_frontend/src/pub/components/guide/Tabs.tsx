  ...
  return (
    <div>
      <TabStrip selected={selected} onSelect={handleSelect}>
        <TabStripTab title="Activated System">
          <div>
            <p>
              ...
              in 2013 of 2,229,621 within its administrative limits. The city is
              both a commune and department, and forms the centre and
        ...
        <TabStripTab title="In progress">
          <div>
            <p>
              ...
              area of just 305 square miles (790 km2), New York City is also the
              most densely populated major city in the United States. Located at
            ...
            <p>
              ...
              upon commerce, finance, media, art, fashion, research, technology,
              ...
              been described as the cultural and financial capital of the world.
            </p>
          </div>
        </TabStripTab>
        <TabStripTab title="Alert">
          <div>
            <p>
              ...
              Finland, 80 km (50 mi) south of Helsinki, east of Stockholm and
              west of Saint Petersburg. From the 13th century until 1918 (and
              briefly during the Nazi occupation of Estonia from 1941 to 1944),
              the city was known as Reval. Tallinn occupies an area of 159.2 km2
              (61.5 sq mi) and has a population of 443,894. Approximately 32% of
              Estonia's total population lives in Tallinn.
            </p>
            <p>
              ...
              cities of Northern Europe. Due to its strategic location, the city
              became a major trade hub, especially from the 14th to the 16th
              century, when it grew in importance as part of the Hanseatic
              League.
            </p>
          </div>
        </TabStripTab>
